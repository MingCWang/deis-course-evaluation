                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            Company regarding the use of the Service. This Terms
                            and Conditions agreement has been created with the
                            help of the{' '}
                            <a
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Rate My Courses,
                            accessible from{' '}
                            <a
                                href='https://www.deiseval.com'
                                rel='external nofollow noopener noreferrer'
                                target='_blank'
                            >
                                https://www.deiseval.com
                            </a>
                        </p>
                    </li>
                    <li>
